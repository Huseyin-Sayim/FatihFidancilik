...
@section("content")
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ route('services.create') }}" class="btn btn-primary float-end">Yeni Hizmet Ekle</a>
        </div>
                        ...
                        <div class="d-inline-flex">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('services.edit', ['id' => $item->id]) }}" class="dropdown-item">
                                        <i class="ph-pencil me-2"></i>
                                        Düzenle
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a href="{{ route('services.delete', ['id' => $item->id]) }}" class="dropdown-item delete">
